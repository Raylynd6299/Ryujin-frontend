        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">{t('finance.expensesDescription')}</p>
                </div>
                <Sheet open={open} onOpenChange={setOpen}>
                    ...
                    <SheetContent>
                        <SheetHeader>
                            <SheetTitle>{t('finance.addExpense')}</SheetTitle>
                        </SheetHeader>
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    <p className="text-muted-foreground">{t('finance.noExpenses')}</p>
